...
import { ArrowLeft, CheckCircle2, AlertCircle, Tag, Layers, FileText, X, Loader2, Save } from 'lucide-react';
                ...
                >
                  <div className="flex items-start justify-between mb-1">
                    <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase ${
                      item.type === 'story' ? 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-200' : 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-200'
                    }`}>
                      {item.type}
                    </span>
